...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'This portfolio itself is a testament to my skills,  It is designed to be a central hub for my work, showcasing my ability to build beautiful and responsive web applications.',
      image: don2,
      tags: ['web', 'react', 'tailwind','framer-motion', 'javascript'],
    ...
    },
    {
      ...
      image: don3,
      tags: ['web', 'react', 'javascript', 'tailwind','framer-motion', 'Express.js', 'Mongo.db'],
    ...
    },
    {
      id: 6,
      title: 'Learn-X',
      description: 'This comprehensive online learning platform was built from the ground up using the MERN stack (MongoDB, Express.js, React.js, Node.js). From crafting the dynamic frontend with React and JavaScript to designing robust APIs and managing data with MongoDB, I immersed myself in the entire development process.',
      image: don6,
